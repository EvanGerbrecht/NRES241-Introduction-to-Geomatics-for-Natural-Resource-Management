...
**Deliverable 1** Submit a line chart that is a sum of burned area in hectares over time (HINT: To answer this question first create a summary table, then review Lab 1 for instructions on how to create a Line Chart using the data from this table.)

##### Q10: Do you see any patterns in the total annual burned area between 1920 and the present day? Do some research and discuss what do you think could be driving these patterns. Refer to your Line Chart to support your answer. Answer in less than 200 words. {.unnumbered}
