...
##### Deliverable 1: Generate a line chart showing the sum of burned area over time in hectares. (Hint: review what we covered in Lab 1 for instructions on how to generate a Line Chart using the data from this table)

##### Q10: Do you see any patterns in the total annual burned area between 1920 and the present day? Do some research and discuss what you think could be driving these patterns. Answer in less than 200 words. In your answer, refer to the line chart you submitted previously {.unnumbered}
...
**Submit your final map in the Deliverable 2 Question on Canvas.**
